...
//  buildhouseproject
//
//  Created by pooh on 15/11/2565 BE.
//

import SwiftUI

//แก้เป็นหน้าใน sidebar
                    ...
                    ScrollView(.vertical , showsIndicators: true)
                    {
                        VStack{ //hp
                            ...
                            ForEach(vm.housefilteredItems) {item in
                                ...
                                ExtractedView(item: HouseItem(id: item.id, image: item.image, name: item.name, price: item.price, company: item.company, description: item.description, isFaved: item.isFaved,videoFileName: item.videoFileName, videoImage: item.videoImage))
